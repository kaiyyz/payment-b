...
export default function Home() {
  const makePayment = async () => {
    ...
    var options = {
      ...
      name: "Humming Payment Technologies",
      currency: data.currency,
      amount: data.amount,
      order_id: data.id,
      description: "Thankyou for your test donation",
      image: "https://www.blucoin.financial/static/media/blu.5299f680.png",
  ...
  return (
    <div>
      <Head>
        <title>Integrate Payments with BLU 🔥</title>
        <meta
          name="description"
          content="Integrate payments in BLU solutions.Digital Wallets and Payment Terminals"
        />
    ...
    <div className="relative z-10 flex flex-col md:flex-row mt-10 items-center  max-w-6xl justify-evenly mx-auto">
      <div className="md:w-1/3 mb-20 md:mb-0 mx-10">
        <h1 className=" text-white font-bold text-5xl mb-10">
          ...
          in seconds and low rates.
        </h1>
        <p className="text-sm text-gray-300 font-light tracking-wide w-[300px] mb-10">
          Learn how to integrate a Payment Gateway with BLU solutions. Pay and recieve your payments
          instantly. Transfer money in less than 3 seconds!
        </p>
